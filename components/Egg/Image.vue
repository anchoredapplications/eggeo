<script setup lang="ts">
  import { randomHexColor } from '~/utils/randomHexColor.ts'; 
  ...
  let stop1Color, stop2Color, stop3Color 
  if (props.color) {
...
<template>
    <svg viewBox="0 -80 270 400" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000" :stroke-width="strokeWidth ?? 3">
